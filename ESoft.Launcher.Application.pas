...
Type
  ...
  Public
    ...
    Procedure LoadApplications(iSubLevelCount: Integer = -1);
...
Procedure TEApplicationGroup.LoadApplications(iSubLevelCount: Integer = -1);
Var
...
Begin
  ...
  Begin
    ...
    If sCurrFileMask.StartsWith('*_') Then
    Begin
      If iSubLevelCount = -1 Then
        Integer.TryParse(sCurrFileMask.Replace('*_', ''), iSubLevelCount);
      sCurrFileMask := '*';
    End;
    ...
    Begin
      ...
      Begin
        ...
        Repeat
          ...
          Begin
            If (iSubLevelCount <> 0) And (Not StrStartsWith(varSearch.Name, '.')) Then
            Begin
              ...
              varAppGroup.LoadApplications(IfThen(iSubLevelCount = -1, -1, Pred(iSubLevelCount)));
            End;
          End
...
Begin
  ...
  FormMDIMain.RunApplication(Name, ExecutableName, aParameter, FinalSourceFolder, SkipFromRecent, RunAsAdmin);
End;
...
Begin
  ...
  FormMDIMain.RunApplication(Name, sFileName, aParameter, sTargetFolder, Owner.SkipFromRecent, varRunAsAdmin);
End;
